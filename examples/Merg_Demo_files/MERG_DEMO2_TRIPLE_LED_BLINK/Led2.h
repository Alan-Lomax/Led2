...
class Led2 {
  ...
  public:
    Led2(byte pin);                     // Prototype for simple constructor 
    Led2(byte pin, unsigned long on, unsigned long off);  // this includes the on and off time values from the outset
